# Лабораторная работа 12. Применение объектно-ориентированного подхода (ООП)

## 1. Цель и краткое описание задания

**Цель:** Освоить принципы объектно-ориентированного программирования (ООП), такие как создание классов, объектов, применение инкапсуляции и организация взаимодействия между объектами.

**Описание:** Разработано консольное приложение «Система учёта студентов» на Python. Реализованы классы `Student` (для инкапсуляции данных студента) и `Group` (для управления списком объектов `Student` и выполнения операций). Данные сохраняются в файл `students.json`.
...
if __name__ == "__main__":
    run_example()
```
### 3. Скриншоты работы программы (Пример ввода и вывода)

![Консольный вывод программы "Система учёта студентов"](1.png)